...
- **Platform**: Canvas, Gradescope[1][2]
...
### Homework 1
- **Status**: Graded[15]
- **Grading Date**: October 21, 2025[15]
- **Gradescope Link**: https://www.gradescope.com/courses/1145396/assignments/6924503/submissions/357351005[15]
- **Class Statistics**[15]:
  - Minimum: 6.5[15]
  - Maximum: 31.0[15]
  - Mean: 21.9[15]
  - Median: 22.5[15]
  - Standard Deviation: 5.23[15]


#### Code Submission
- **Assignment**: HW2 Code Submission[16]
- **Collaborator**: Ryan Yan added user to submission[16]
- **Date**: October 20, 2025[16]
- **Gradescope Link**: https://www.gradescope.com/courses/1145396/assignments/6961527/submissions/360182011[16]


### Quiz 0_B

#### Problem 3 - Regrade Request Reviewed
- **Issue**: Incomplete proof - showing roots are non-integers is insufficient[17]
- **Feedback**: Must state the only candidates are $$\frac{1}{2}\le x\le\frac{1}{4}$$ and note there are no integers in that range[17]
- **Status**: Fixed for partial credit[17]
- **Date Reviewed**: October 19, 2025[17]


## Office Hours

- **Instructor**: Pratyay Dutta[18]
- **Day**: Mondays[18]
- **Time**: 4:30-5:30pm[18]
- **Location**: WCH 461[18]
- **Directions**: Elevator beside Bytes → 4th floor → First lab on right → Knock on door[18]
- **Previous Location**: WCH 110 (changed October 17, 2025)[18]



#### Code Submission
- **Collaborator**: Ryan Yan added user to submission[19]
- **Date**: October 25, 2025[19]
- **Gradescope Link**: https://www.gradescope.com/courses/1145396/assignments/6961527/submissions/362464516[19]


### Quiz 2
- **Due Date**: Wednesday, October 29, 2025[20]
- **Test Begin Date**: October 28, 2025[20]
- **Test End Date**: October 29, 2025[20]
- **Location**: CS Department Test Center, Winston Chung Hall 132[20]
- **Duration**: 50 minutes[20]
- **Reservation Link**: https://testcenter.cs.ucr.edu/Make-Change-Delete-Reservations[20]
- **Reservations Open**: October 24, 2025 at 8:00 AM[20]
- **Test Center Info**: https://testcenter.cs.ucr.edu[20]

#### Exam Rules[20]
- Closed notes, closed book[20]
- No electronic devices, including calculators[20]
- Must show work and provide justification when appropriate[20]
- Only front pages will be scanned; use last blank page if more room needed[20]
- Use back side of previous page for scratch space[20]


### Quiz 1 B
- **Status**: Graded[21]
- **Date Graded**: October 23, 2025[21]
- **Gradescope Link**: https://www.gradescope.com/courses/1145396/assignments/6984678/submissions/358878166[21]
...
- **Mean**: 18.5[21]
- **Median**: 18.75[21]
- **Standard Deviation**: 5.56[21]


### Quiz 1 B
- **Status**: Graded[22]
- **Date Graded**: October 23, 2025[22]
- **Gradescope Link**: https://www.gradescope.com/courses/1145396/assignments/6984678/submissions/358878166[22]
